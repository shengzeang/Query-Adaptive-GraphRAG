...
prefix_prompt = "You are given a sentence or short passage containing one blank (___) and four answer options (A-D). \
    Each option is linguistically plausible, but only one is factually and contextually correct. \
        Your task is to: Select the option that best completes the sentence so that it is semantically coherent, factually accurate, \
            and consistent with real-world entity relationships (e.g., is-a, located-in, causes, part-of)."
